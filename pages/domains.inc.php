...
// - es muss mount_id oder alias domain eingebenen sein
// - wenn mount_id, dann auch start_id und notfound_id
// - wenn alias, dann nicht mount_id/start_id, notfounc_id
// - Domain ohne http://
// - Alias domain als selectbox
...
if($func != "") {
  ...
  $xform->setValueField("text",array("alias_domain",$I18N->msg("yrewrite_alias_domain")));
...
if($showlist) {
  ...
  echo '<p class="rex-button"><a class="rex-button" href="index.php?page=yrewrite&subpage=&func=add"><span>+ '.$I18N->msg("yrewrite_add_domain").'</span></a></p>';

  $sql = 'SELECT * FROM rex_yrewrite_domain';
